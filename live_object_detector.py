...
def pre_process_image( frame ):
    ...
    img = cv2.resize( frame, tuple( [300, 300] ) )
...
def infer_image( labels, graph, img, frame ):
...
def main(camera, labels):
    ...
    while( True ):
        ...
        infer_image( labels, graph, img, frame )
